...
/* Maze represents a maze of characters. The goal is to get from the top left corner to the bottom right, 
 * following a path of 1's. Arbitrary constants are used to represent locations in the maze that have been 
 * TRIED and that are part of the solutions PATH.
 */
public class Maze
{
